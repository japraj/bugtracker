...
import { selectSideNavWidth } from "./features/navigation/NavigationSlice";
...
const App = () => {
  ...
  useEffect(() => {
    ...
    // store results in user var, call the below functions
    // make sure to remove the setTimeout; it is only present
    // to simulate the delay generated by a server request!
